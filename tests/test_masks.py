...
@pytest.mark.parametrize(
    "card_fixture", ["non_int_str_value", "non_digit_str_value"]
)
...
@pytest.mark.parametrize(
    "card_number", [12345678876543212, "98765432198765412", 0, "0"]
)
...
@pytest.mark.parametrize(
    "account, expected",
    [(12345678876543212224, "**2224"), ("98765432198765433538", "**3538")],
)
...
@pytest.mark.parametrize(
    "account_fixture", ["non_int_str_value", "non_digit_str_value"]
)
...
@pytest.mark.parametrize(
    "account", [123456788765432128769, "987654321987654127215", 0, "0"]
)
